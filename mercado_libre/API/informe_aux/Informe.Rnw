...
arbol <- load(here("mercado_libre/modelos","arbol_train.RDS"))

arbol.prune <- load(here("mercado_libre/modelos","arbol_prune_train.RDS"))

#### RF

rf_train <- load(here("mercado_libre/modelos","RF_train.RDS"))

rf_train_mr <- load(here("mercado_libre/modelos","RF_train_mr.RDS"))


#### Boosting

boosting_train <- load(here("mercado_libre/modelos","boosting_train.RDS"))

boosting_train_mr <- load(here("mercado_libre/modelos","boosting_train_mr.RDS"))
