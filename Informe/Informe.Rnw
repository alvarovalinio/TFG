...
Se destaca que las metodologías detalladas ateriormente permitieron en gran parte de los casos corregir las georreferencias no factibles o consideradas errónes, con excepción de algunos apartamentos. Estos últimos se tratan de apartamentos con coordenadas geográficas que, si bien se encuentran dentro del cuadrante donde se ubica Montevideo y a su vez coincide la ubicación respecto a la calle Avenida Italia en continuación con la calle Avenida 18 de Julio con respecto al centroide del barrio en el cual está ubicado, los mismos se encuentran fuera del polígono de Montevideo. Sin embargo, se tiene que las excepciones mencionadas representan un valor inferior al 0.1 \% de las observaciones.
...
Como se observa en la Figura \ref{map3}, el precio de oferta en dólares de los apartamentos incrementa conforme aumenta la proximidad de la ubicación de los mismos a la rambla este de Montevieo. En contraparte, se observa que el precio disminuye para los apartamentos que se encuentran en barrios ubicados hacia el norte de Montevideo.

Por otro lado, se observa una mayor concentración de apartamentos en barrios ubicados hacia el sur de Montevideo. Por último, como fue mencionado en la Sección \ref{sec:procesamiento}, se tiene que algunos apartamentos quedaron ubicados fuera del polígono de Montevideo.
