...
\textbf{\large Aplicación de técnicas de aprendizaje estadístico e interpretabilidad, caso de estudio: predicción del precio de oferta de apartamentos a la venta en Montevideo, Uruguay}
